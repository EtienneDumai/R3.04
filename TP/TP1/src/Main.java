...
/** 4.METHODES USUELLES      -non- **/
    ...
    static public void modifierLeParametreAdresse (Ingredients ingredients1) {
        System.out.println ("... je recois l'adresse de l'ingredient "+ ingredients1.toString());
        ...
        ingredients1 = unNouveau;
        System.out.println ("... le parametre recu pointe sur ce nouvel ingredient "+ ingredients1.toString()+" et la fonction se termine");
    }

    static public void modifierObjetPointeParLeParametre (Ingredients ingredients1) {
        System.out.println ("... je recois l'adresse de l'ingredient "+ ingredients1.toString());
        ingredients1.set_quantite(0);
        System.out.println ("... je modifie la quantite "+ ingredients1.toString()+" et la fonction se termine");
    }
